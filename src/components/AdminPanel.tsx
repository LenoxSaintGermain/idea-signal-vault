...
import { Users, FileText, Zap, TrendingUp, Trash2, Edit, Star, RotateCcw, Database } from 'lucide-react';
    ...
    try {
      ...
      if (success) {
        toast({
          ...
          description: "Mock pain points have been added to the database",
        });
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex space-x-2">
          <Button onClick={handleSeedData} variant="outline" className="text-blue-600 border-blue-600 hover:bg-blue-50">
        ...
        <TabsContent value="content" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  ...
                  {painPoints.slice(0, 5).map((idea) => (
                    <div key={idea.id} className="flex items-center justify-between p-3 bg-red-50 rounded-lg">
                      ...
                      <div className="flex space-x-1">
                        ...
                        <Button size="sm" variant="ghost" className="p-1 h-6 text-red-600">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {regularIdeas.slice(0, 5).map((idea) => (
